const changeTab = (buttons, contents, targetNumber) => {
...
const init = () => {
    $(document)
        ...
        const self = this;
        const wrapper = self.closest('.JsTab');
        const buttons = wrapper.querySelectorAll('.JsTab__button');
        const contents = wrapper.querySelectorAll('.JsTab__contents');
